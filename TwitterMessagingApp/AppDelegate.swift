...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    private enum Constants: String {
        case key = "HMZrDiVDPuaXIDE1XanlrD7Nj"
        case secret = "WoNNxV9FyhxLrQFsnAzbD6FmHnPSXAglVKF0NYZS5zQoFFcLBg"
    }
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "TwitterMessagingApp")
